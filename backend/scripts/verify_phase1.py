...
async def verify():
    ...
    try:
        async with async_engine.connect() as conn:
            ...
            print("\n--- Verifying Tables ---")
            tables = [
                'tenants', 'users', 'tenant_memberships', 'oauth_accounts', 
                'sessions', 'api_keys', 'team_invites', 'episodic_memories', 
                'semantic_memories', 'contradiction_log', 'compression_log', 
                'evaluation_runs', 'evaluation_metrics', 'audit_log', 
